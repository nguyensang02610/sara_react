  ...
  return (
    <SafeAreaView style={{backgroundColor: '#FFF', height: '100%', flex: 1}}>
      ...
      <View style={styles.ViewTextInput}>
        <Icon name="mail" color="#a21d30" size={24} />
        <TextInput
          placeholder="Email"
          placeholderTextColor="#a21d30"
        ...
        {data.check_textInputChange ? (
          <Animatable.View animation="bounceIn">
            <Feather name="check-circle" color="#a21d30" size={20} />
          </Animatable.View>
        ) : null}
      </View>
      ...
      <View style={styles.ViewTextInput}>
        <Icon name="md-lock-closed" color="#a21d30" size={28} />
        <TextInput
        ...
        <TouchableOpacity
          ...
          {data.secureTextEntry ? (
            <Feather name="eye-off" color="#a21d30" size={22} />
          ) : (
            <Feather name="eye" color="#a21d30" size={22} />
          )}
        </TouchableOpacity>
      </View>
